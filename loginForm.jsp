...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <form action="aaa" method="post">
	...
	ID:<input type="text"name="j_username" placeholder="ID">
	</div>
	<p></p>
	<div class="form-group">
	Password:<input type="text"name="j_password" placeholder="Password">
	</div>
	<p></p>
	</center>
	</div> 
	<center>
	<button type="submit" class="btn btn-primary">&nbsp&nbsp&nbspLog in&nbsp&nbsp&nbsp</button>
	<button type="submit" class="btn btn-info">&nbsp&nbsp&nbsp&nbspJoin&nbsp&nbsp&nbsp&nbsp</button>
	</center>  	 	
