     	...
     	<div class="col-md-8">
	        ...
	        <!-- @@@@안에 변수 전부 변경@@@@@-->
			      ...
			      <div class="form-group">
			        ...
			        <input type="text" class="form-control" id="b_address" name="b_address" placeholder="상품준비중/배송중/배송완료">
			      </div>
			      <p></p>	
				  <hr/>
			      <button type="button" class="btn btn-primary" onclick="location.href='/buyCheck'">변경하기</button>
