     	...
     	<div class="col-md-8">
	        ...
	        <!-- Blog Post -->
			      ...
			      <div class="form-group">  
			        <label for="subject"><Strong>Buyer</Strong></label>
			         <textarea name="name" class="form-control" placeholder ="구매자: <sec:authentication property="name"/>"></textarea>
			      </div>
			      <p></p>
			      <div class="form-group" >
			        <label for="p_name"><Strong>Product Name</Strong></label>
			        <textarea name="pno" class="form-control" placeholder ="상품번호: ${dto.p_no}"></textarea>
				  ...
				  <hr/>
			      <input type="submit" class="btn btn-primary" value="BUY" onclick="location.href='/member/loginOkIndex'">
